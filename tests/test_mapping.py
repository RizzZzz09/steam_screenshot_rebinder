...
def _make_img(path: Path, size=(16, 16), color=(128, 128, 128), fmt="JPEG") -> None:
    """Создаёт тестовое изображение и сохраняет его в указанном формате.
...
def test_build_pairs_counts(tmp_path: Path) -> None:
    """Проверяет корректность формирования пар при разном числе файлов."""
...
def test_preview_pairs_and_info(tmp_path: Path) -> None:
    """Проверяет предпросмотр пар и получение информации об изображении."""
